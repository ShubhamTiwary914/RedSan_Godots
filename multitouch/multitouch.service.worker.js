...
/** @type {string} */
const CACHE_VERSION = '1726591527|6471058744';
/** @type {string} */
const CACHE_PREFIX = 'Multitouch View-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'multitouch.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["multitouch.html","multitouch.js","multitouch.offline.html","multitouch.icon.png","multitouch.apple-touch-icon.png","multitouch.worker.js","multitouch.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["multitouch.wasm","multitouch.pck"];
